...
bot = TeleBot(token="6385753843:AAFHohj4wpQbJNZTzPu-4TEQu15EfFcwQEU",num_threads=45,threaded=True,skip_pending=True,parse_mode='html', disable_web_page_preview=True)

bot2 = TeleBot(token="6385753843:AAFHohj4wpQbJNZTzPu-4TEQu15EfFcwQEU",num_threads=45,threaded=True,skip_pending=True,parse_mode='Markdown', disable_web_page_preview=True)

if not db.get('accounts'):
    db.set('accounts', [])
    pass
admin = 6024124201 #الادمن
